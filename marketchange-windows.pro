...
TARGET =
VERSION = 0.1.0
INCLUDEPATH += src src/json src/qt c:/QRCodeGUI
DEFINES += QT_GUI BOOST_THREAD_USE_LIB BOOST_SPIRIT_THREADSAFE BOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN __NO_SYSTEM_INCLUDES
CONFIG += no_include_pwd

# Change paths to your dependencies if needed
...
BOOST_INCLUDE_PATH=C:/deps1/boost
BOOST_LIB_PATH=C:/deps1/boost/stage/lib
BDB_INCLUDE_PATH=c:/deps1/db/build_unix
BDB_LIB_PATH=c:/deps1/db/build_unix
OPENSSL_INCLUDE_PATH=c:/deps1/ssl/include
OPENSSL_LIB_PATH=c:/deps1/ssl
QRENCODE_LIB_PATH=c:/QRCodeGUI
OBJECTS_DIR = build
MOC_DIR = build
UI_DIR = build
