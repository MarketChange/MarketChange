...
uint256 hashGenesisBlock("0xf629b689b1f7f278b96c251d1edcea89f8966d4a600173958a86a7f973454ed2");
...
const string strMessageMagic = "MarketChange Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	else if(nHeight < 1148000){
		nSubsidy = 40 * COIN;
	}
	else if(nHeight < 1722000){
		nSubsidy = 30 * COIN;
	}
	else{
		nSubsidy = 25 * COIN;
...
static const int64 nTargetTimespan = 110; // Retarget Every 2 Blocks
static const int64 nTargetSpacing = 55; // 55 Second Block Target
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal marketchange miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MarketChange", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd90d082b0d8a28bab5f00918abd607447ae825ebfbd3c9ea99e168db9ca2bafc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Initial Idea and Genesis Block Creation: February 17, 2014 GMT-7";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392692563; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1332212;

        if (fTestNet)
        {
            block.nTime    = 1392692553;
            block.nNonce   = 3302079;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x36540927205f2257f8a394f5d59ef28a3311d5e9dcfadbabada1fe7d317ac5b4"));
